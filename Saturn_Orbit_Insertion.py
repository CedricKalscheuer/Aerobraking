...
r_p_lowest                  = 40                # Lowest Periapsis tested
r_p_highest                 = 201               # Highest Periapsis tested  
r_p_step_size               = 40                # Step size between r_p_lowest and r_p_highest
...
max_step_critical           = 3             # maximum step size during simulation for critical areas
...
def simulate_trajectory(b, r_thrust_descend, r_thrust_ascend, r_p_slow, thrust_duration, short_run=True, max_step_large=max_step_non_critical, max_step_small=max_step_critical, launch_time=0, critical_distance=critical_distance_titan_sim):
    ...
    while t_start < t_end:
        ...
        # Perform integration
        sol = solve_ivp(eom, t_span, init_val, args=p, method='RK45', rtol=1e-8, atol=1e12,max_step=max_step_current, events=event_list)
